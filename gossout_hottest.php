...
$sql = "SELECT c.post_id,count(distinct(c.sender_id)) as commentCount,p.community_id FROM `comments` as c JOIN post as p on c.post_id=p.id group by c.post_id order by commentCount desc";

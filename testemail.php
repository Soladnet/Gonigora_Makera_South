                ...
                <div class="inner_wrappper box_shadow8 center_div ">
                    <div id="column1" style="width: 100%">
                        <div  class="community_index index_fnx" > 
                            <span> <h1 class="fnx"><img src="images/G.png" /> Ahmadu Bello University, Zaria<hr> </h1>
                    ...
                    <div id="footer" class="p_name">
                        ...
                        <table cellspacing="5px">
                            <tr >
                                <td colspan="3" style="font-size: 13px" font-family: 'Segoe UI',sans-serif;> This message was sent to soladnet@hotmail.com.
                            </td>
                        </tr>
                    </table>
                    <div class="clear"></div>

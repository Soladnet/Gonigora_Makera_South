                ...
                <div class="inner_wrappper box_shadow8 center_div ">
                    <div id="column1" style="width: 100%">
                        <div  class="community_index index_fnx" > 
                            <span> <h1 class="fnx"><img src="images/G.png" /> Ahmadu Bello University, Zaria<hr> </h1><a href="http://www.gossout.com/page.php?view=notification&open="><span class="box_shadow8 center_div" style="display: block; width: 40%;text-align: center;background-color:#99c53d;font-size: .9em; ">Comment on Post</span></a>
                                <p class="fnx_detail"><img src="upload/thumbnails/1344921594_48_1342_100x100.jpeg" align="left"/><strong>Abdulrasheed Soladoye</strong><br/>Gossout Abdulkarim Rukayyahsincein King Fin Ahmadu Bello University, Zaria, NigeriaGossout Abdulrasheed SoladoyeGossout Abdulkarim Rukayyahsincein King Fin Ahmadu Bello University, Zaria, NigeriaGossout Abdulrasheed SoladoyeGossout Abdulkarim Rukayyahsincein King Fin Ahmadu Bello University, Zaria, NigeriaGossout Abdulrasheed SoladoyeGossout Abdulkarim Rukayyahsincein King Fin Ahmadu Bello University, Zaria, Nigeria</p>
                            </span>
                            <a href="#"><span class="box_shadow8 center_div" style="display: block; width: 40%;text-align: center;background-color:#99c53d;font-size: .9em; ">Comment on Post</span></a>
                        </div>
